# Goal Vault Product Plan

## 1. Product Definition

### Core idea
Goal Vault is a Base-native USDC savings product where a user creates a vault for one specific purpose, funds it over time, and cannot withdraw until the chosen rule allows it.
...
## 2. Product Thesis
Goal Vault should make saving feel:
